...
ru: [
  { q: 'Когда вступила в силу действующая Конституция Финляндии?',
    a: ['В 2000 году', 'В 1919 году', 'В 1995 году'] },
  { q: 'Какой орган отвечает за систему регистрации населения Финляндии?',
    a: ['Агентство цифровых и демографических данных (DVV)', 'Kela', 'Migri'] },
  { q: 'Что означает «право каждого» (jokamiehenoikeus) в Финляндии?',
    a: ['Право свободно передвигаться на природе', 'Право голоса на выборах', 'Право на бесплатное образование'] },
  { q: 'Каков срок президентских полномочий в Финляндии?',
    a: ['6 лет', '4 года', '5 лет'] },
  { q: 'Когда Финляндия вступила в Европейский союз?',
    a: ['В 1995 году', 'В 2004 году', 'В 1999 году'] },
  { q: 'Сколько депутатов насчитывает финский парламент (Eduskunta)?',
    a: ['200', '201', '150'] },
  { q: 'Что такое Kela?',
    a: ['Институт социального страхования Финляндии', 'Парламент Финляндии', 'Налоговая служба'] },
  { q: 'Когда Финляндия провозгласила независимость?',
    a: ['6 декабря 1917 года', '17 июля 1919 года', '1 января 1918 года'] },
  { q: 'Сколько официальных языков в Финляндии?',
    a: ['Два (финский и шведский)', 'Один (финский)', 'Три (финский, шведский и саамский)'] },
  { q: 'Какой принцип означает, что все равны перед законом в Финляндии?',
    a: ['Верховенство права и равноправие', 'Свобода слова', 'Право на неприкосновенность частной жизни'] },
  { q: 'Какова форма правления в Финляндии?',
    a: ['Парламентская республика', 'Конституционная монархия', 'Президентская республика'] },
  { q: 'Что означает принцип открытости государственных документов в Финляндии?',
    a: ['Документы органов власти по умолчанию общедоступны', 'Все судебные заседания открыты для публики', 'Все граждане обязаны участвовать в выборах'] },
  { q: 'Как избирается премьер-министр Финляндии?',
    a: ['Парламент избирает премьер-министра', 'Граждане избирают напрямую', 'Президент назначает без одобрения парламента'] },
  { q: 'Как часто в Финляндии проводятся парламентские выборы?',
    a: ['Раз в четыре года', 'Раз в пять лет', 'Раз в три года'] },
  { q: 'Какова роль парламентского омбудсмена в Финляндии?',
    a: ['Контролировать соблюдение основных прав и законность действий властей', 'Руководить судебной системой', 'Представлять Финляндию в международных организациях'] },
  { q: 'Какова столица Финляндии?',
    a: ['Хельсинки', 'Турку', 'Тампере'] },
  { q: 'Что означает муниципальное самоуправление в Финляндии?',
    a: ['Муниципалитеты отвечают за местные услуги — образование и социальную помощь', 'Муниципалитеты могут принимать собственные законы', 'Муниципалитеты обязаны соблюдать только директивы ЕС'] },
  { q: 'Кого распространяется новое требование об экзамене на гражданство Финляндии?',
